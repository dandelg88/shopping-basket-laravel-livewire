                ...
                @forelse($products as $product)
                    <li class="flex p-4 border-b border-gray-400">
                        ...
                        <div class="flex items-center flex-shrink px-4">
                            ...
                            <div class="px-2">{{ $product->qty }}</div>
                        ...
                        <div class="flex-shrink pr-4">${{ $product->formatted_price }}</div>
                        <div wire:click="remove({{ $product->id }})" class="flex-shrink text-red-600 cursor-pointer">Remove</div>
                    </li>
                @empty
                    <li class="flex p-4 border-b border-gray-400">
